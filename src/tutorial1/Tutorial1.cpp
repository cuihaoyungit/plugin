...
EXPORT void DllStartPlugin(IPluginManager* pm)
{
    CREATE_PLUGIN(pm, Tutorial1)
};

EXPORT void DllStopPlugin(IPluginManager* pm)
{
...
{
    REGISTER_MODULE(pPluginManager, IHelloWorld1, HelloWorld1)
}

void Tutorial1::Uninstall()
{
    UNREGISTER_MODULE(pPluginManager, IHelloWorld1, HelloWorld1)
}